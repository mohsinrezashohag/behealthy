...
router.route('/check-availability').post(authMiddleware, userControllers.checkAvailability)
router.route('/get-appointments-by-id').get(authMiddleware, userControllers.getAppointmentsById)
